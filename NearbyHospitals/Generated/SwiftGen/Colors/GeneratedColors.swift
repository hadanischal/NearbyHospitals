...
internal struct ColorName {
  ...
  /// <span style="display:block;width:3em;height:2em;border:1px solid black;background:#2db5f8"></span>
  /// Alpha: 100% <br/> (0x2db5f8ff)
  internal static let primary = ColorName(rgbaValue: 0x2db5f8ff)
